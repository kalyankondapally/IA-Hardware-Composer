sudo EGL_LOG_LEVEL=debug MESA_DEBUG=1 LD_LIBRARY_PATH=/home/kalyan/install-kms/lib/:/home/kalyan/install-kms/lib/x86_64-linux-gnu ./linux_test -f 50 -j /home/kalyan/IA-Hardware-Composer/tests/jsonconfigs/kmscube1layer.json  >& log.txt
